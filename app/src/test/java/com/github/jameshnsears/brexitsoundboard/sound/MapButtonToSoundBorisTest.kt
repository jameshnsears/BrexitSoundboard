...
class MapButtonToSoundBorisTest : AbstractMapButtonToSound() {
    ...
    fun ensureButtonsPlayCorrectSounds() {
        keyValueMap[R.id.buttonBoris350MillionPoundsAWeek] =
            R.raw.boris_sound_350_million_pounds_a_week
        keyValueMap[R.id.buttonBorisAllYourOptionsAreGood] =
            R.raw.boris_sound_all_your_options_are_good
        keyValueMap[R.id.buttonBorisCostOfGettingOutVirtuallyNil] =
            R.raw.boris_sound_cost_of_getting_out_virtually_nil
        keyValueMap[R.id.buttonBorisHiggeldyPiggeldyNations] =
        ...
        keyValueMap[R.id.buttonBorisWeightLiftedFromBritishBusiness] =
        ...
        keyValueMap[R.id.buttonBorisLittleBenefitFromEU] =
            R.raw.boris_sound_little_benefit_from_single_market_and_customs_union
        keyValueMap[R.id.buttonBorisUkShapingTheModernWorld] =
            R.raw.boris_sound_uk_shaping_the_modern_world
        keyValueMap[R.id.buttonBorisBrexitHasNotDamagedCountry] =
        ...
        keyValueMap[R.id.buttonBorisAsLongAsItTakes] =
        ...
        keyValueMap[R.id.buttonBorisFriendsAreABitNegative] =
