...
class MapButtonToSoundLiamTest : AbstractMapButtonToSound() {
    ...
    fun ensureButtonsPlayCorrectSounds() {
        ...
        keyValueMap[R.id.buttonLiamCitizensFirstNotPolitics] =
            R.raw.liam_sound_citizens_first_not_politics
        keyValueMap[R.id.buttonLiamEasiestInHumanHistory] =
            R.raw.liam_sound_easiest_in_human_history
        keyValueMap[R.id.buttonLiamNotHavingADealWouldBeBad] =
            R.raw.liam_sound_not_having_a_deal_would_be_bad
        keyValueMap[R.id.buttonLiamThisIsNotJustAboutEurope] =
        ...
        keyValueMap[R.id.buttonLiamShockTherapyRequiredForEu] =
        ...
        keyValueMap[R.id.buttonLiamThinkOfTheConsequences] =
